# Spring Carpinteria Melerita Application 
...
```
git clone https://github.com/JoseCarlosMorales/TFG.git
cd carpinteria-melerita
./mvnw package
java -jar target/*.jar
```
...
In its default configuration, Carpinteria Melerita Application uses an in-memory database (H2) which
